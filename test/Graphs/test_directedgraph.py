import unittest
import pytest
from Pycollection.Graphs.DirectedGraph import DirectedGraph
...
class TestDirectedGraph (unittest.TestCase):
    ...
    def setup_and_teardown (self) -> None:
        ...
        self.__collection = DirectedGraph (5)
    ...
    def test_edge (self) -> None:
        ...
        :rtype: None
        """
        self.assertListEqual (self.__collection.edges, [[0, 10, 0, 0, 0], [0, 0, 20, 0, 0], [0, 0, 0, 30, 0], [0, 0, 50, 0, 0], [0, 40, 0, 0, 0]])
